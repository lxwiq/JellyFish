package com.lowiq.jellyfish.jellyseer.infrastructure
...
import com.lowiq.jellyfish.jellyseer.auth.*
...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                "cookieAuth" to ApiKeyAuth("query", "connect.sid"), 
                "apiKey" to ApiKeyAuth("header", "X-Api-Key"))
    }

    companion object {
          const val BASE_URL: String = "http://localhost:5055/api/v1"
